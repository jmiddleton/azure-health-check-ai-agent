...
class UpdateHealthCheckExcel:
    ...
    def _download_excel(self) -> BytesIO:
        ...
        site_url = "https://puntanegra.sharepoint.com/sites/Integration" #TODO: externalize this

        headers = {"Authorization": f"Bearer {self.token}"}
        site_url = "https://graph.microsoft.com/v1.0/sites/puntanegra.sharepoint.com:/sites/Integration"
