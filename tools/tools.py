...
def get_metrics(
    ...
    if resource_name:
        ...
        if resource_id:
            resource_id = resource_id.replace("https://portal.azure.com/#@punta.negra.com.au/resource", "")
...
def perform_healthcheck() -> list[dict]:
    """Performs a full health of the integration platform."""
    return perform_healthcheck_from_file("DailyHealthCheck.csv")
